...
type CollectionProps = {
    ...
    totalPages?: number,
    urlParamName?: string,
    collectionType?: 'Events_Organized' | 'My_Tickets' | 'All Events',
    ...
    <>
        {
            data.length > 0 ? (
                ...
                <div className = " text-center bg-grey-50 py-28 flex-center wrapper min-h-[200px] w-full flex-col rounded-[14px]">
